...
type dryRunProvider struct {
	inner *MariaDBProvider
}

func (d *dryRunProvider) Name() string { return "mariadb" }
...
func (d *dryRunProvider) Writer(_ context.Context, opts provider.WriteOptions) provider.Writer {
	return &dryRunWriter{
		opts: opts,
		log:  logger.L().With("component", "mariadb-dryrun-writer"),
	}
}
...
func (w *dryRunWriter) Flush(_ context.Context) error { return nil }
